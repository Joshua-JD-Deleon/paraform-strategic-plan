    ...
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 text-white">
      ...
      <div className="container relative z-10 mx-auto px-4 py-12 md:py-16">
        <div className="mx-auto max-w-[1200px] text-center">
          <h2 className="text-3xl font-bold mb-3 bg-gradient-to-r from-white via-blue-100 to-blue-300 bg-clip-text text-transparent">
          ...
          <div className="mb-6">
            <Button
              asChild
              size="lg"
              className="bg-blue-500 text-white hover:bg-blue-400 shadow-lg hover:shadow-blue-500/50 hover:shadow-xl transition-all duration-300 font-semibold"
            >
              <a
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button
              ...
              size="sm"
              variant="ghost"
              className="text-slate-300 hover:text-white hover:bg-white/10 hover:shadow-blue-500/20"
            >
