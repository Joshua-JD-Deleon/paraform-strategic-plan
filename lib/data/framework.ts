...
export const foundationSteps: FrameworkStep[] = [
  {
    ...
    criteria: "Platform fluency with recruiter workflows, matching algorithms, GMV drivers",
  ...
  },
  {
    ...
    criteria: "Health metrics defined with GMV, velocity, engagement, churn indicators",
  ...
  },
  {
    ...
    criteria: "Portfolio segmented by potential, performance, engagement level",
  ...
  },
  {
    ...
    criteria: "1:1 relationships established with regular cadence, trust built",
...
export const operationalSteps: FrameworkStep[] = [
  {
    ...
    criteria: "Advisory calls delivering value with actionable recommendations",
  ...
  },
  {
    ...
    criteria: "Recruiter workflows optimized for speed, quality, conversion",
  ...
  },
  {
    ...
    criteria: "Coaching cadence established with measurable improvement",
  ...
  },
  {
    ...
    criteria: "Onboarding-to-activation friction points identified and resolved",
...
export const growthSteps: FrameworkStep[] = [
  {
    ...
    criteria: "Growth playbooks driving measurable GMV lift per recruiter",
  ...
  },
  {
    ...
    criteria: "Experiments designed, executed, measured with clear hypotheses",
  ...
  },
  {
    ...
    criteria: "At-risk detection with intervention playbooks, engagement drivers",
  ...
  },
  {
    ...
    criteria: "Liquidity metrics improved through strategic recruiter activation",
...
export const scaleSteps: FrameworkStep[] = [
  {
    ...
    criteria: "Daily insights translated into product improvements and tools",
  ...
  },
  {
    ...
    criteria: "Tools specs delivered improving ops efficiency and scale",
  ...
  },
  {
    ...
    criteria: "Success patterns documented for team-wide adoption",
  ...
  },
  {
    ...
    criteria: "Ops insights informing GTM, product roadmap, company strategy",
